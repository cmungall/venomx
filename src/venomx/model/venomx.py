...
class Index(ConfiguredBaseModel):
    ...
    embeddings: Optional[List[Embedding]] = Field(default_factory=list, description="""The embeddings for named objects""")
    ...
    embedding_input_method: Optional[ModelInputMethod] = Field(None, description="""The method used to generate the input for the embedding model""")
